    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/dashboard/translate" className="group">
          ...
          <Link href="/dashboard/voice" className="group">
            <Card className="h-full hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer bg-gradient-to-br from-white to-slate-50">
              <CardHeader>
          ...
          <Link href="/dashboard/worksheets" className="group">
            <Card className="h-full hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer bg-gradient-to-br from-white to-slate-50">
              <CardHeader>
          ...
          <Link href="/dashboard/curriculum" className="group">
            <Card className="h-full hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer bg-gradient-to-br from-white to-slate-50">
              <CardHeader>
          ...
          <Link href="/dashboard/offline" className="group">
