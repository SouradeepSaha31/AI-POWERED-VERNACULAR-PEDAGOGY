      ...
      <main className="flex-grow flex items-center justify-center p-6">
        <div className="max-w-4xl w-full mx-auto flex flex-col items-center text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-2xl font-light">
            Empowering teachers to teach children in their mother tongue with
            real-time translation and AI-generated materials.
          </p>

          <Link to="/dashboard">
            <Button
              size="lg"
              className="h-14 px-8 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 bg-emerald-600 hover:bg-emerald-700 text-white border-0 mb-16"
            >
